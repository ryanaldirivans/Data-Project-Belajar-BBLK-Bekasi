...
<body>
  <?php
  $name1 = "Aziz";
  $email1 = "aziz2001@gmail.com";
  $komen1 ="Enak sekali kak kue nya";

  $name2 = "Anggita Maya";
  $email2 = "anggitamaya@gmail.com";
  $komen2 = "Harganya murah dan rasanya enak!";
  ?>
  ...
  <div class= "container-fluid">
    <div class="row">
      <div class= "col-12 bg-primary text-light">
       ...
       <!-- awal navbar -->
       <nav class="navbar col-12 navbar-expand-lg navbar-light sticky-top " style="background-color: #ff66b3; padding-left: 15px; margin-right: 10px">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ">
              <a class="nav-link active" href="table.html">Data Komentar</a>
            </li>    
          </ul>
      ...
      <!-- ini adalah data komentar -->
      <div class="container" style="padding-top: 20px">
        <h2 align="center">Data Komentar</h2>
        <table class="table table-hover">
          <thead class="text-light" style="background-color: #994d00;">
            <tr>
              <th scope="col">No</th>
          ...
          <tbody>
            ...
            <!-- <tr>
              <th scope="row">3</th>
              <td>Anggita Maya</td>
              <td>anggitamaya@gmail.com</td>
              <td>Harganya murah dan rasanya enak!</td>
            </tr>
            <tr>
              <th scope="row">4</th>
              <td>Sinta Ayu</td>
              <td>aysinta@yahoo.com</td>
              <td>Kasirnya ramah banget....</td>
            </tr> -->
          </tbody>
        </table>
        <!-- ini akhir komentar -->
      ...
      <!-- ini adalah banner sebelah kanan -->
