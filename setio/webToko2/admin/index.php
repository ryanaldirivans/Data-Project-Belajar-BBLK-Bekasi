...
if(isset($_GET['page'])){
  ...
  switch ($page) {
    ...
    break;
    case 'formInputUser':
    $page = "formInputUser.php";
    break;
    case 'formInputBarang':
    $page = "formInputBarang.php";
    break;
    case 'logout':
    $page = "logout.php";
    break;   
    case 'FormInputTransaksi':
    $page = "FormInputTransaksi.php";
    break;  
    case 'DataTransaksi':
    $page = "DataTransaksi.php";
    break;
    case 'buku':
    $page = "buku.php";
    break;   
...
<body>
  ...
  <div class= "container-fluid">
    <div class="row">
      ...
      <div class="container"> <!-- Untuk halaman form -->
        <?php include_once $page;?>
      </div>
      <div class="col-12 col-md-4 col-lg-2" style="background-color: #ffb3d9;" align="justify"><img src="assets/images
        /business-icon.jpg" height="200" alt="" style="float: left;">
        <p>
